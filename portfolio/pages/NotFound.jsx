...
function NotFound() {
  return (
    <div className="d-flex flex-column justify-content-center align-items-center text-center vh-100 px-3" style={{ backgroundColor: '#FEE9C6', zIndex: 1, pointerEvents: 'auto' }}>
