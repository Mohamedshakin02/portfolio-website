...
function Intro() {
    return (
        <>
            <div className="top-layer position-absolute container-fluid p-0 " style={{ pointerEvents: "none" }}>
                ...
                <div className="scroll-container container-fluid bg-body-tertiary z-3" style={{ pointerEvents: "auto" }}>
                    <Swiper
                        ...
                        className="mySwiper container-lg display-6 fw-medium py-3"
                    >
                        <SwiperSlide>
            ...
            <div class="intro-container container-lg" style={{ position: 'relative', pointerEvents: "auto" }}>
                <div className="intro-content p-4 h-50">
