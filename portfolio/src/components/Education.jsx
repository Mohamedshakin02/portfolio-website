            ...
            <div className="education-container container-md">
                ...
                <div className="education-content p-4 p-lg-5 d-flex flex-column gap-5" style={{ pointerEvents: "auto" }}>
                    <div className="school border  mb-2 p-3 p-md-4">
                            ...
                            <div className='year'>
                                <p className='number fs-5 fw-medium m-md-1 pt-0 pt-md-2 pt-lg-0'>2009-2021</p>
                            </div>
                    ...
                    <div className="high-school border mb-2 p-3 p-md-4">
                            ...
                            <div className='year '>
                                <p className='number fs-5 fw-medium m-md-1 pt-0 pt-md-2 pt-lg-0'>2021-2023 </p>
                            </div>
                    ...
                    <div className="bachelor border mb-3 p-3 p-md-4">
                            ...
                            <div className='year '>
                                <p className='number fs-5 fw-medium m-md-1 pt-0 pt-md-2 pt-lg-0'>2023-present </p>
                            </div>
