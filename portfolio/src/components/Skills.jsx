    ...
    return (
        <>
            <div className="skills-container container-md">
                ...
                <div className="skills-content p-4 pt-5 pb-5 p-lg-5 gap-5" style={{ pointerEvents: "auto" }}>
                    ...
                    <div className='skill game p-4 d-flex flex-column justify-content-between'>
                        ...
                        <div className='bottom-container mt-4 d-flex flex-column justify-content-between'>
                            ...
                            <div className='tools mt-3 mb-2 h-25'>
                                <p className='m-0 fs-5 fw-medium align-self-start'>Tools: Unity, Twine, Bitsy, p<span className='number fs-6'>5</span>.js</p>
                            </div>
                        </div>
                    </div>
                </div>
