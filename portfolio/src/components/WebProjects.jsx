...
import '../App.css';
import '/stylesheet/web_projects.css';
...
function WebProjects() {
    ...
    return (
        <>
            <div className="web-projects-container container-md">
                <h1 className="display-3 fw-semibold text-center mb-5">Web Development</h1>

                <div className="web-projects-content p-4 p-lg-5" style={{ pointerEvents: "auto" }}>
                    <Swiper
                        slidesPerView={1}
                        spaceBetween={50}
                        loop={true}
                    ...
                    >
                        {projects.map((project, index) => (
                            <SwiperSlide key={index}>
                                <div className="web-project-card p-4 h-100 d-flex flex-column">
                                    <img
                                        src={project.image}
                                        alt={project.title}
